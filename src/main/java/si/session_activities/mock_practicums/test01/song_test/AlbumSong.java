...
public class AlbumSong extends Song {
    ...
    public AlbumSong(String title, String author, Genre genre, 
                            int runtime, String albumTitle) {
    ...
    public String toString() {
        return this.getTitle() + " by " + this.getAuthor() + " from " + 
        this.getAlbumTitle() + ": " + this.getRuntime() + 
        " seconds, Genre: " + this.getGenre();
    }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof AlbumSong){
            ...
            this.getRuntime() == other.getRuntime() && 
